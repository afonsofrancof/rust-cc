use data_structs::dns_message::{DNSMessage, DNSMessageData, DNSMessageHeaders, DNSQueryInfo};
...
pub fn test_query(){
    ...
    let query_data = DNSMessageData{query_info,authorities_values:None,response_values:None,extra_values:None};
